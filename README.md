...
- Copying Jar & input data to sandbox
- Running SparkPageRank Scala application & examining the results
...
Once the project compiles you are ready to generate the page-rank.jar for the project. Here are the steps needed:
 ...
 ## Copying Jar & input data to Hortonwork Sandbox
 ...
 3- Upload the page-rank.jar file and the [urldata.txt] into hdfs which is included in our github repository.
 
 4- Connect via Putty to your Sandbox see image below.
 
 5- Create the directory & subdirectory ~/testing/jars on the local Linux system upon which Hortonwork Sandbox is running.
